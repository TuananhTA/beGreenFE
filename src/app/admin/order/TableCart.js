...
const TableCart = ({ codeBill }) => {
    ...
    const listBillDetailOrder = [
        { idBillDetail: "1", nameProduct: "Rau A", quantityBillDetail: 2, priceDiscount: 15000000 },
        { idBillDetail: "2", nameProduct: "Rau B", quantityBillDetail: 5, priceDiscount: 300000 },
        { idBillDetail: "3", nameProduct: "Rau C", quantityBillDetail: 3, priceDiscount: 1200000 },
        { idBillDetail: "4", nameProduct: "Rau D", quantityBillDetail: 4, priceDiscount: 3500000 },
        { idBillDetail: "5", nameProduct: "Rau E", quantityBillDetail: 6, priceDiscount: 800000 },
        { idBillDetail: "6", nameProduct: "Rau F", quantityBillDetail: 2, priceDiscount: 15000000 },
        { idBillDetail: "7", nameProduct: "Rau G", quantityBillDetail: 5, priceDiscount: 300000 },
        { idBillDetail: "8", nameProduct: "Rau H", quantityBillDetail: 3, priceDiscount: 1200000 },
        { idBillDetail: "9", nameProduct: "Rau I", quantityBillDetail: 4, priceDiscount: 3500000 },
        { idBillDetail: "10", nameProduct: "Rau K", quantityBillDetail: 6, priceDiscount: 800000 },
    ];
    ...
    // useEffect(() => {
    //     console.log("listBillDetailOrder", listBillDetailOrder)
    //     setCurrentPage(1)
    // }, [listBillDetailOrder]);
                    ...
                    {currentItems && currentItems.length > 0 ? (
                        currentItems.map((item, index) => (
                            <tr key={item.idBillDetail}>
                                ...
                                <td>
                                    {/* <ListImageProduct id={item.idProductDetail} maxWidth={'100px'} maxHeight={'100px'} /> */}
                                </td>
                                <td>
                                    <div>
                                        {item.nameProduct}
                                ...
                                <td>
                                    <div className='d-flex justify-content-center'>
                                        <FaTrash className='text-danger' size={'30px'} onClick={() => handleDeleteByIdBillDetail(item.idBillDetail, item.idProductDetail)} />
                                    </div>
                                </td>
                            </tr>
                        ))
