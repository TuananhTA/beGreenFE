...
const ModalAddVoucher = ({ idAccount, totalMerchandise }) => {
    ...
    const { listVoucherPublic, listVoucherPrivate } = {
        listVoucherPublic: [],
        listVoucherPrivate: []
    }
    ...
    return (
        <>
            <Button variant="primary" onClick={handleShow} style={{ width: '60px' }} className='d-flex justify-content-center'>
                <CiDiscount1 size={'25px'} />
            </Button>
            <Modal
                show={show}
                onHide={handleClose}
