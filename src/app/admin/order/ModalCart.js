...
const ModalCart = ({ codeBill, setCodeBill }) => {
    ...
    const listBillDetailOrder = [
        { name: "Rau A", quantity: 2, price: 15000000 },
        { name: "Rau B", quantity: 5, price: 300000 },
        { name: "Rau C", quantity: 3, price: 1200000 },
        { name: "Rau D", quantity: 4, price: 3500000 },
        { name: "Rau E", quantity: 6, price: 800000 }
    ];
    // useEffect(() => {
